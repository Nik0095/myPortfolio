  ...
  return (
    <div className="py-20 w-full">
      <h2 className="heading">
        Your site, <span className="text-purple">fully supported</span> — no
        hidden struggles.
      </h2>
      <div className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl max-w-3xl mx-auto mt-8">
        I stay with you after launch, fixing issues and keeping your site on
        track — you’re never on your own.
        <PointerHighlight
        ...
        >
          <span className="relative z-10">
            Never left alone — full support for your site at every step.
          </span>
        </PointerHighlight>
      </div>
